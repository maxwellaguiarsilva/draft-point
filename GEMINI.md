...
- **Verification:** 
    ...
    3.  **False Positives:** LLMs frequently generate false positives regarding the spacing of `( )` and `[ ]`. Never trust your visual intuition. If you suspect a violation, verify using the `verify_spacing` MCP tool.
